...
class WatchFace3CanvasRenderer(
    ...
    */
    ...
    override fun render(
        ...
        if (!drawAmbient) {
            if (FinalStatic.setPictureDefault == 0) {
                val bg = BitmapFactory.decodeResource(
                    context.resources,
                    BitmapTranslateUtils.currentBg(watchFaceData.shapeStyle.shapeType)
                )
                canvas.drawBitmap(bg, null, bounds, clockPaint)
                //FinalStatic.setPictureDefault = 1
            }
            ...
            //canvas.drawBitmap(bg,null, bounds ,clockPaint)
//            if (FinalStatic.setPicture == 0){
//                PictureUtils.getPicture(canvas,bounds,clockPaint)
    ...
    private fun drawTime(canvas: Canvas, bounds: Rect, zonedDateTime: ZonedDateTime) {
        ...
        if (watchFaceData.shapeStyle.shapeType == STYLE1 && !drawAmbient) {
            ...
            if (watchFaceData.positionStyle.positionStyle == PositionStyle1) {
                canvas.drawText(
                    BitmapTranslateUtils.currentTime(),
                    233f - textWidth / 2,
                    baseLineY + 340f,
                    style1Paint1
                )
        ...
        if (watchFaceData.shapeStyle.shapeType == STYLE2 && !drawAmbient) {
            ...
            //当前字体的样式
            val textWidth: Float =
                style2paint1.measureText(BitmapTranslateUtils.currentWeekdayAll())
            //绘制当前的星期
            ...
            when (watchFaceData.positionStyle.positionStyle) {
                PositionStyle1 -> {
                    canvas.drawText(
                        BitmapTranslateUtils.currentWeekdayAll(),
                        233f - textWidth / 2,
                        146f,
                        style2paint1
                    )
            ...
            canvas.drawBitmap(
                centerBitmap,
                bounds.exactCenterX() - centerBitmap.width / 2,
                bounds.exactCenterY() - centerBitmap.height / 2,
                clockPaint
            )
        ...
        if (watchFaceData.shapeStyle.shapeType == STYLE3 && !drawAmbient) {
            ...
            textBoardPaint.typeface =
                Typeface.createFromAsset(context.assets, "fonts/RobotoText-Regular.otf")
            ...
            if (watchFaceData.positionStyle.positionStyle == PositionStyle1) {
                ...
                canvas.drawText(
                    BitmapTranslateUtils.currentWeekdayNotAll(),
                    240f,
                    125f,
                    style3Paint2
                )
                ...
                canvas.drawText(
                    BitmapTranslateUtils.currentData(),
                    233f - textWidth,
                    125f,
                    style3Paint2
                )
            ...
            //绘制星期
            textPaint.typeface =
                Typeface.createFromAsset(context.assets, "fonts/RobotoFlex-Regular.ttf")
        ...
        if (watchFaceData.shapeStyle.shapeType == STYLE4 && !drawAmbient) {
            ...
            if (watchFaceData.positionStyle.positionStyle == PositionStyle1) {
                ...
                val batteryIcon =
                    BitmapFactory.decodeResource(context.resources, R.drawable.batt_icon)
        ...
        if (watchFaceData.shapeStyle.shapeType == STYLE6 && !drawAmbient) {
            ...
            when (watchFaceData.positionStyle.positionStyle) {
                PositionStyle1 -> {
                    //绘制当前的时间
                    val textWidth: Float =
                        style6Paint1.measureText(BitmapTranslateUtils.currentTime())
                    canvas.drawText(
                        BitmapTranslateUtils.currentTime(),
                        233f - textWidth / 2,
                        390f,
                    ...
                    //绘制电量图标
                    val batteryIcon =
                        BitmapFactory.decodeResource(context.resources, R.drawable.battery_icon_6)
                ...
                PositionStyle2 -> {
                    ...
                    textPaint.textSize = 22f
                    textPaint.typeface =
                        Typeface.createFromAsset(context.assets, "fonts/MiSans_Medium.ttf")
                    val batteryStatus: Intent? =
                        context.registerReceiver(null, IntentFilter(Intent.ACTION_BATTERY_CHANGED))
            ...
            //绘制电量图标
            val batteryIcon =
                BitmapFactory.decodeResource(context.resources, R.drawable.style_6_icon)
...
//                }
        ...
        if (watchFaceData.shapeStyle.shapeType == STYLE9 && !drawAmbient) {
            ...
            if (watchFaceData.positionStyle.positionStyle == PositionStyle1) {
                ...
                canvas.drawText(
                    BitmapTranslateUtils.currentDay9(),
                    300f - textWidth,
                    189f,
                    style9Paint1
                )
                ...
                when (complication.complicationData.value) {
                    is ShortTextComplicationData -> {
                        ...
                        if (watchFaceData.shapeStyle.shapeType == STYLE1 && watchFaceData.positionStyle.positionStyle == PositionStyle1 && complication.id == TOP_COMPLICATION_ID_1) {
                            complicationPaint1.color =
                                context.getColor(watchFaceData.activeColorStyle.colorInt)
                            ...
                            complicationPaint3.color =
                                context.getColor(watchFaceData.activeColorStyle.colorInt)
                            complicationPaint4.color =
                                context.getColor(watchFaceData.activeColorStyle.colorInt)
